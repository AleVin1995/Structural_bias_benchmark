...
do
    ...
    sbatch --job-name=CERES_"$LIB" --mem-per-cpu=150GB src/method/run_tools.sh /group/iorio/Alessandro/CN_benchmark/ CERES $LIB
    # sbatch --job-name=MAGeCK_"$LIB" --mem-per-cpu=100GB --array=1-100%55 src/method/run_tools.sh /group/iorio/Alessandro/CN_benchmark/ MAGeCK $LIB
done
